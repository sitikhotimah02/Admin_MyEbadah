            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form style="width:100%;" action="/subbab/store" method="POST" enctype="multipart/form-data">
                ...
                <table class="table">
                    ...
                    <tr>
                        <tr>
                            ...
                            <td>
                                <a href="/quizsubbab/{{ $bab->Materi_Detail_Id }}" class="btn btn-success btn-sm">Tes</a>
                         ...
                         <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form style="width:100%;" method="POST" action="/subbab/delete/{{$bab->Materi_Id}}" id="#Group_Id_Delete" enctype="multipart/form-data">
                                        {{csrf_field()}}
                        ...
                        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                    <form style="width:100%;" method="POST" action="/subbab/update" id="formEditGroup" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                        <div class="form-group">
